...
import type { MaterialSuporte, EstruturaEncontro } from '@/api/courses'
import type { ProgramaEditor } from '@/composables/usePrograma'

const props = defineProps<{ editor: ProgramaEditor }>()
const {
  expandedId, expandedSemana, completingId, materialToggling, selectingAllId, hoverStep,
  programa, progress, concluidosEfetivos, totalEncontros, progressPct, sidebarFacts,
  nextEncontro, metricsRows, ribbonShow, ribbonMsg, jornada, metodologia, entregaveisResumo,
  instSteps, materialChecks,
  ...
  romano, isExternalUrl, parseMatItem, numSemanas,
} = props.editor
</script>
