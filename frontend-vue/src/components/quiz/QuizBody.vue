...
import type { QuizEditor } from '@/composables/useQuizEditor'

const props = defineProps<{ editor: QuizEditor }>()
const {
  quizIdParam, encontroId, quiz, myResponse, answers, feedback, error, lastSubmit, sessionQuizWithRationales,
  showReport, submitting, reviewMode, questoes, allAnswered, sessionReport, reviewReport,
...
<template>
  <div v-if="quiz">
    ...
    <template v-if="questoes.length > 0">
